...
public class CabecerasServlet extends HttpServlet {
    ...
    protected void procesaPeticion(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<ul>");
            //recuperamos las cabeceras de la peticion, 
            //primero con el metodo getHeadersNames
            // y lo recorremos 
            Enumeration<String> nombresDeCabeceras = request.getHeaderNames();
            //forma éstandar de recorrer un Enumeration
            while (nombresDeCabeceras.hasMoreElements()) {
                //en esta linea recuperamos el nombre
                ...
                out.println("<li><b>" + cabecera + ": </b>"
                        ...
                        //a traves del nombre , que es el String cabecera y que hemos
                        //recuperado con getHeaderNames()
